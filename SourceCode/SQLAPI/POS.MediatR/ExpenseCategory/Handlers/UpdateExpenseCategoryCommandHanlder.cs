...
namespace POS.MediatR.Handlers
{
    public class UpdateExpenseCategoryCommandHanlder
        : IRequestHandler<UpdateExpenseCategoryCommand, ServiceResponse<ExpenseCategoryDto>>
    {
        ...
        public async Task<ServiceResponse<ExpenseCategoryDto>> Handle(UpdateExpenseCategoryCommand request, CancellationToken cancellationToken)
        {
            ...
            if (existingEntity != null)
            {
                ...
                return ServiceResponse<ExpenseCategoryDto>.Return409("Expense Category already Exists.");
            }
            ...
            if (existingEntity == null)
            {
                ...
                return ServiceResponse<ExpenseCategoryDto>.Return409("Expense Category does not Exists.");
            }
            existingEntity.Name = request.Name;
            _expenseCategoryRepository.Update(existingEntity);

            var entityDto = new ExpenseCategoryDto
            {
            ...
            return ServiceResponse<ExpenseCategoryDto>.ReturnResultWith200(entityDto);
        }
    }
}
