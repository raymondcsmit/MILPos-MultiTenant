...
namespace POS.MediatR.Handlers
{
    public class UpdateInquirySourceCommandHandler
        : IRequestHandler<UpdateInquirySourceCommand, ServiceResponse<InquirySourceDto>>
    {
        ...
        public async Task<ServiceResponse<InquirySourceDto>> Handle(UpdateInquirySourceCommand request, CancellationToken cancellationToken)
        {
            ...
            if (existingEntity != null)
            {
                ...
                return ServiceResponse<InquirySourceDto>.Return409("Inquiry Source Already Exist for another Delivery Method.");
            }
            ...
            var entityDto = new InquirySourceDto
            {
                Id = existingEntity.Id,
                Name = existingEntity.Name
            };
            return ServiceResponse<InquirySourceDto>.ReturnResultWith200(entityDto);
        }
    }
}
