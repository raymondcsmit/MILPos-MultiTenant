            ...
            if (pageSize == 0)
            {
                var entities = await source
                    ...
                    .Select(cs => new ExpenseDto
                    {
                        ...
                        ExpenseBy = cs.ExpenseBy != null ? cs.ExpenseBy.FirstName + " " + cs.ExpenseBy.LastName : null,
                        ExpenseById = cs.ExpenseById,
                        ExpenseCategory = cs.ExpenseCategory.Name,
                        ExpenseCategoryId = cs.ExpenseCategoryId,
                        Reference = cs.Reference,
                        CreatedDate = cs.CreatedDate,
                        ExpenseDate = cs.ExpenseDate,
                        ReceiptName = cs.ReceiptName,
                        ExpenseTaxes = _mapper.Map<List<ExpenseTaxDto>>(cs.ExpenseTaxes),
