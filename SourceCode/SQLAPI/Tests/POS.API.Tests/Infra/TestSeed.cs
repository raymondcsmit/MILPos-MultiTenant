...
public sealed class TestSeed(IServiceProvider serviceProvider)
{
    ...
    [
        ...
        "PRO_MANAGE_VARIANTS",
        "SETT_MANAGE_CITY", "SETT_MANAGE_COUNTRY", "SETT_MANAGE_LAN", "SETT_UPDATE_COM_PROFILE",
        "DB_BEST_SELLING_PROS", "REP_SALES_VS_PURCHASE_REP", "DB_STATISTICS",
        "LOAN_MANAGE_LOAN", "LOAN_VIEW_LOANS",
        "PAY_ROLL_MANAGE_PAY_ROLL", "PAY_ROLL_VIEW_PAY_ROLLS",
        "USR_ASSIGN_USR_ROLES", "USR_ASSIGN_USR_PERMISSIONS",
        "MENU_VIEW_MENUS", "MENU_ADD_MENU", "MENU_UPDATE_MENU",
