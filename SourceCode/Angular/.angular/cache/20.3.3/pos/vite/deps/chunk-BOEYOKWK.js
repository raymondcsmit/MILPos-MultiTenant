...
function createRootTView(rootSelectorOrNode, componentDef, componentBindings, directives) {
  const tAttributes = rootSelectorOrNode ? ["ng-version", "20.3.2"] : (
...
var IterableDiffers = class _IterableDiffers {
  ...
  static extend(factories) {
    return {
      ...
      useFactory: () => {
        const parent = inject(_IterableDiffers, { optional: true, skipSelf: true });
...
var KeyValueDiffers = class _KeyValueDiffers {
  ...
  static extend(factories) {
    return {
      ...
      useFactory: () => {
        const parent = inject(_KeyValueDiffers, { optional: true, skipSelf: true });
...
@angular/core/fesm2022/debug_node.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-BOEYOKWK.js.map
